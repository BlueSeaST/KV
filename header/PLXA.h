...
int PLXAstr_snprintf(char *pParam1, int iParam2, char *Param3, ...);//ZDSPTR.c add by fkp
int PLXAstr_vsnprintf(char *pcReturn, int iSize, char *pcFormat, va_list param);
