...
typedef char DTXA_secs_obj_type_string[0x29];

typedef char DTXA_secs_timestamp_string[0x2A];

typedef char DTXA_secs_obj_id_string[0x51];

typedef char DTXA_lot_id_string[0x40];

typedef char DTXA_lot_type_string[0xF];

typedef char DTXA_wafer_semilot_id_string[0x51];
...
typedef char DTXA_secs_wafer_reject_reason_string[0xCB];
...
typedef char DTXA_layer_id_string[0x17];
...
typedef char DTXA_tag_model_id_string[0x6];

typedef char DTXA_tag_firmware_id_string[0x6];

typedef char DTXA_device_id_string[0xF];

typedef char DTXA_align_strategy_id_string[0x19];

typedef char DTXA_recipe_id_string[0xFF];
...
typedef char DTXA_variant_id_string[0xF];
...
typedef char DTXA_PRJOBID_type[0x51];
...
typedef char DTXA_MID_type[0x51];
...
typedef char DTXA_RCPSPEC_type[0xFF];

typedef char DTXA_RCPPARNM_type[0x101];

typedef char DTXA_RCPPARVAL_type_strVal[0x51];
...
typedef char DTXA_PRCMDNAME_type[0x7];
...
//	DTXA_SUBSTRATES = 14,
//} DTXA_PRMtlType_type;
typedef DTXA_MF_type DTXA_PRMtlType_type;
...
typedef char DTXA_process_calibration_id_string[0x19];
