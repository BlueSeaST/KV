...
typedef struct
{
    LEXAxSPOT_spot_selection_t Z_capture_spot_selection; // 0x0 // 0x20
    bool Ry_capture_needed; // 0x4
    LEXAxSPOT_spot_selection_t Ry_capture_spot_selection; // 0x8
    bool change_of_process; // 0xC // 用了typedef int bool的话，bool是4字节
    bool on_process; // 0x10
} RLXA_capture_def_t; // 0x14
...
typedef struct
{
    LEXAxDEF_statmeas_report_t ags_heights_report; // 0x0 // 0x8
    LEXAxDEF_statmeas_data_t ags_heights_data; // 0x78
} RLXA_get_result_ags_height_t; // 0x120
