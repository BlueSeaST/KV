...
typedef struct
{
    KVXT_TIS_drift_ref_struct_height height; // 0x0
    LEXAxSPOT_spot_selection_t measValid; // 0x48
} KVXT_TIS_drift_ref_struct; // 0x50
...
typedef struct
{
    ...
    KVXT_iVSA_plate_fallback_shape_dz dz; // 0x8
    timestamp last_update; // 0x50
    bool valid; // 0x58
    bool reduced_usability_enabled; // 0x5C
    KVXT_iVSA_plate_fallback_shape_usability_per_spot usability_per_spot; // 0x60
    double avg_y_shape; // 0x88
} KVXT_iVSA_plate_fallback_shape; // 0x90
