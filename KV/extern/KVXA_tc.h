...
typedef struct
{
    bool capture_needed; // 0x0
    zrxryvect capture_zrxry; // 0x8
    RLXA_capture_def_t capture_def; // 0x20
} KVXA_capture_params; // 0x38
...
typedef struct
{
    RLXA_get_result_ags_height_t plate_level_result; // 0x0 // 0x8
    KVXA_plate_level_result_measure_z_valid measure_z_valid; // 0x120 // 这里要把bool看成4字节
	char unk_s0x144[4]; // 填充4字节，不知道为什么
    bool capture_z_valid; // 0x148
} KVXA_plate_level_result; // 0x150
...
typedef struct
{
    MEXAxWAFxPLATE_wafer_level_plate plate_id; // 0x0
    KVXA_plate_level_info_plate_res plate_res; // 0x8 结构体中含double // 0x8 + 0x150 * 0x19 = 0x20D8
    xyavect ws_exp_pos_xyrz;// 指令中该位置的偏移为0x20D8，据此推断前后变量的偏移地址
    zrxryvect ws_exp_pos_zrxry; // 0x20F0
    double plate_avg_z; // 0x2108
    bool plate_avg_z_valid; // 0x2110
    double plate_error_z; // 指令中该位置的偏移为0x2118，据此推断前后变量的偏移地址
    int nr_meas_results; // 0x2120
    KVXA_plate_level_info_avg_z_per_spot avg_z_per_spot; // 0x2128
    KVXA_plate_level_info_avg_z_per_spot_valid avg_z_per_spot_valid; // 0x2170
	char unk_s0x2194[4]; // 0x2194 // 填充4字节，不知道为什么
    int nr_valid_meas_results; // 0x2198
} KVXA_plate_level_info; // 0x21A0
...
typedef struct
{
    MEXAxVSA_XVSA_fiducial_drift plate_drift; // 0x0
    double plate_deformation; // 0x12E8
} KVXA_XVSA_plate_model_results; // 0x1300
...
typedef struct
{
    KVXA_XVSA_plate_model_results TIS1; // 0x0
    KVXA_XVSA_plate_model_results TIS2; // 0x1300
    KVXA_XVSA_chuck_model_results_dZ_LE_spot dZ_LE_spot; // 0x2600
    KVXA_XVSA_chuck_model_results_dZ_LE_spot_valid dZ_LE_spot_valid; // 0x2648
    double dRy_LE; // 0x2658
	char unk_0x2660[0x10]; // 因在0x2670处赋值了一个double，故填充如下
	double d0x2670;
} KVXA_XVSA_chuck_model_results; // 0x2678
