...
typedef struct
{// 0x40
    LEXAxDEF_measgrid_table_t measgrid_table; // 0x0
    LEXAxDEF_meas_spot_valid_table_t meas_spot_valid_table; // 0x2590
    LEXAxDEF_servo_spot_valid_table_t scan_servo_spot_valid_table; // 0x4B18
} RLxTABLESET_table_set_t; // 0x70A0
